//
//  ManualReportGlobalErrorViewController.swift
...
import UIKit
import Dynatrace
class ManualReportGlobalErrorViewController: UIViewController {
    ...
    @IBAction func btnGlobalError_Touch(_ sender: Any) {
        let action = DTXAction.enter(withName: "Tap Global Error")
